...
public class MainActivity extends AppCompatActivity {
        ...
        btnConvert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!edtEuroValue.getText().toString().isEmpty())
                {
                    ...
                    Toast.makeText(MainActivity.this, ""+ toCurr , Toast.LENGTH_SHORT).show();
    ...
    public void loadConvTypes() throws IOException {
        ...
        String url = "https://openexchangerates.org/api/latest.json?app_id=13e341ebee74465a9c0451375f7ea3c3";
